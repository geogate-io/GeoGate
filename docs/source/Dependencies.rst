...
This section aims to give brief information to install additional dependencies to run GeoGate plugins through
the use of `spack <https://spack.readthedocs.io/en/latest/index.html>`_ package manager and it's extension 
`spack-stack <https://spack-stack.readthedocs.io/en/latest/>`_.

==============================
Creating New Spack Environment
==============================
...
Spack-stack is a framework for installing software libraries to support NOAA's
`UFS (Unified Forecast System) Weather Model <https://ufs-weather-model.readthedocs.io/en/develop/#>`_
through the use of `spack-stack <https://spack-stack.readthedocs.io/en/latest/>`_ applications and the 
Joint Effort for Data assimilation Integration (JEDI) coupled to several Earth system prediction models 
(MPAS, NEPTUNE, UM, FV3, GEOS, UFS). It is designed to leverage `Spack <https://spack.readthedocs.io/en/latest/>`_ 
